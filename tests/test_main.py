...
async def test_handler_returns_response():
    ...
    with (
        patch("book_flow_writer_agent.main._initialized", True),
...
async def test_handler_initialization():
    ...
    with (
        patch("book_flow_writer_agent.main._initialized", False),
        patch("book_flow_writer_agent.main.initialize_crew", new_callable=AsyncMock) as _mock_init,
        patch("book_flow_writer_agent.main.run_agent", new_callable=AsyncMock, return_value=mock_response),
