...
<h1 align="center">book-flow-writer-agent</h1>

<p align="center">
  <strong>An orchestrated multi-crew Flow that outlines and generates a complete book by coordinating sequential content planning and chapter creation across specialized agents.</strong>
</p>

<p align="center">
  <a href="https://github.com/Avngrstark62/book-flow-writer-agent/actions/workflows/main.yml?query=branch%3Amain">
    <img src="https://img.shields.io/github/actions/workflow/status/Avngrstark62/book-flow-writer-agent/main.yml?branch=main" alt="Build status">
  </a>
  <a href="https://img.shields.io/github/license/Avngrstark62/book-flow-writer-agent">
    <img src="https://img.shields.io/github/license/Avngrstark62/book-flow-writer-agent" alt="License">
  </a>
</p>
...
An orchestrated multi-crew Flow that outlines and generates a complete book by coordinating sequential content planning and chapter creation across specialized agents.. Built on the [Bindu Agent Framework](https://github.com/getbindu/bindu) for the Internet of Agents.
...
git clone https://github.com/Avngrstark62/book-flow-writer-agent.git
cd book-flow-writer-agent
...
```bash
# Start the agent
uv run python -m book_flow_writer_agent
...
gh repo create Avngrstark62/book-flow-writer-agent --public --source=. --remote=origin --push
```
...
```
book-flow-writer-agent/
├── book_flow_writer_agent/
│   ├── skills/
│   │   └── book_flow_writer_agent/
...
- 📖 [Full Documentation](https://Avngrstark62.github.io/book-flow-writer-agent/)
- 💻 [GitHub Repository](https://github.com/Avngrstark62/book-flow-writer-agent/)
- 🐛 [Report Issues](https://github.com/Avngrstark62/book-flow-writer-agent/issues)
...
<p align="center">
  <a href="https://github.com/Avngrstark62/book-flow-writer-agent">⭐ Star this repo</a> •
